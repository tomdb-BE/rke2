...
BASE_VERSION=${BASE_VERSION:-v1.16.7b7}
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.22.2}
RKE2_RELEASE=${RKE2_RELEASE:-rke2r3}
RKE2_MULTIARCH_RELEASE=${RKE2_MULTIARCH_RELEASE:-multiarch-alpha3}
...
CONTAINERD_VERSION=${CONTAINERD_VERSION:-"v1.5.7-k3s1"}
...
KLIPPER_HELM_VERSION=${KLIPPER_HELM_VERSION:-v0.6.5}
NGINX_INGRESS_VERSION=${NGINX_INGRESS_VERSION:-1.0.2-hardened1}
NGINX_INGRESS_DEFAULT_BACKEND_VERSION=${NGINX_INGRESS_DEFAULT_BACKEND_VERSION:-1.5-rancher1}
HARDENED_CALICO_VERSION=${HARDENEDCALICO_VERSION:-v3.20.1}
CALICO_VERSION=${CALICO_VERSION:-v3.20.1}
CALICO_OPERATOR_VERSION=${CALICO_OPERATOR_VERSION:-v1.20.3}
...
DNS_NODE_CACHE_VERSION=${DNS_NODE_CACHE_VERSION:-1.21.1}
CERTGEN_VERSION=${CERTGEN_VERSION:-v1.0}
HARVESTER_VERSION=${HARVESTER_VERSION:-v0.1.1}
...
CILIUM_CHART_VERSION=${CILIUM_CHART_VERSION:-"1.10.104"}
CANAL_CHART_VERSION=${CANAL_CHART_VERSION:-"v3.20.1-build2021100603"}
CALICO_CHART_VERSION=${CALICO_CHART_VERSION:-"v3.20.102"}
CALICO_CRD_CHART_VERSION=${CALICO_CRD_CHART_VERSION:-"v1.0.202"}
COREDNS_CHART_VERSION=${COREDNS_CHART_VERSION:-"1.16.301-build2021100602"}
NGINX_INGRESS_CHART_VERSION=${NGINX_INGRESS_CHART_VERSION:-"4.0.305"}
METRICS_SERVER_CHART_VERSION=${METRICS_SERVER_CHART_VERSION:-"2.11.100-build2021091503"}
MULTUS_CHART_VERSION=${MULTUS_CHART_VERSION:-"v3.7.1-build2021100705"}
VSPHERE_CPI_CHART_VERSION=${VSPHERE_CPI_CHART_VERSION:-"1.0.000"}
VSPHERE_CSI_CHART_VERSION=${VSPHERE_CSI_CHART_VERSION:-"2.1.000"}
HARVESTER_CLOUD_PROVIDER_CHART_VERSION=${HARVESTER_CLOUD_PROVIDER_CHART_VERSION:-"0.1.200"}
HARVESTER_CSI_DRIVER_CHART_VERSION=${HARVESTER_CSI_DRIVER_CHART_VERSION:-"0.1.300"}
