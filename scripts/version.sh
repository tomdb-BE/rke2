...
RKE_RELEASE=${RKE2_RELEASE:-rke2r3}
VERSION=${VERSION:-$KUBERNETES_VERSION-multiarch+$RKE_RELEASE}
...
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-$KUBERNETES_VERSION-$RKE_RELEASE}
