...
BASE_VERSION=${BASE_VERSION:-v1.17.6b7-multiarch}
...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.23.3}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.23.3-rke2r1}
...
CONTAINERD_VERSION=${CONTAINERD_VERSION:-v1.5.9-k3s1}
CRICTL_VERSION=${CRICTL_VERSION:-v1.23.0}
RUNC_VERSION=${RUNC_VERSION:-v1.1.0}
...
KLIPPER_HELM_VERSION=${KLIPPER_HELM_VERSION:-v0.6.8-build20211123}
NGINX_INGRESS_VERSION=${NGINX_INGRESS_VERSION:-nginx-1.0.2-multiarch-hardened2}
NGINX_INGRESS_DEFAULT_BACKEND_VERSION=${NGINX_INGRESS_DEFAULT_BACKEND_VERSION:-1.5-rancher1}
HARDENED_CALICO_VERSION=${HARDENEDCALICO_VERSION:-v3.22.0}
CALICO_VERSION=${CALICO_VERSION:-v3.22.0}
CALICO_OPERATOR_VERSION=${CALICO_OPERATOR_VERSION:-v1.25.0}
CALICO_CRD_VERSION=${CALICO_CRD_VERSION:-v1.0.202}
FLANNEL_VERSION=${FLANNEL_VERSION:-v0.16.3}
CILIUM_VERSION=${CILIUM_VERSION:-v1.11.1}
...
DNS_NODE_CACHE_VERSION=${DNS_NODE_CACHE_VERSION:-1.21.4}
...
CILIUM_CHART_VERSION=${CILIUM_CHART_VERSION:-"1.11.101"}
CANAL_CHART_VERSION=${CANAL_CHART_VERSION:-"v3.20.1-build2021111904"}
CALICO_CHART_VERSION=${CALICO_CHART_VERSION:-"v3.21.401"}
CALICO_CRD_CHART_VERSION=${CALICO_CRD_CHART_VERSION:-"v3.21.201"}
...
VSPHERE_CPI_CHART_VERSION=${VSPHERE_CPI_CHART_VERSION:-"100.1.0+up1.0.100"}
VSPHERE_CSI_CHART_VERSION=${VSPHERE_CSI_CHART_VERSION:-"100.1.0+up2.3.0"}
HARVESTER_CLOUD_PROVIDER_CHART_VERSION=${HARVESTER_CLOUD_PROVIDER_CHART_VERSION:-"0.1.800"}
HARVESTER_CSI_DRIVER_CHART_VERSION=${HARVESTER_CSI_DRIVER_CHART_VERSION:-"0.1.900"}
