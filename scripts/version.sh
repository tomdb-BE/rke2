...
RKE2_PKG=github.com/tomdb-be/rke2
GO=${GO-go}
...
RKE2_MULTIARCH_RELEASE=${RKE_MULTIARCH_RELEASE:-alpha1}
VERSION=${VERSION:-$KUBERNETES_VERSION-multiarch-$RKE2_MULTIARCH_RELEASE+$RKE2_RELEASE}
