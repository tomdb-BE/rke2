...
CALICO_VERSION=${CALICO_VERSION:-v3.81.1}
...
CANAL_VERSION=${CANAL_VERSION:-"v3.13.300-build2021022303"}
...
KUBEPROXY_CHART_VERSION=${KUBEPROXY_CHART_VERSION:-"v1.21.0-build2021041302"}
KUBE_METRICS_SERVER_CHART_VERSION=${KUBE_METRICS_SERVER_CHART_VERSION:-"2.11.100-build2021022300"}
