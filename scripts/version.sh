...
TREE_STATE=clean
COMMIT=$DRONE_COMMIT
VERSION=${VERSION:-v1.21.4+rke2r2}
...
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.21.4-rke2r1}
COREDNS_VERSION=${COREDNS_VERSION:-v1.8.4}
ETCD_VERSION=${ETCD_VERSION:-v3.5.0-k3s1}
METRICS_SERVER_VERSION=${METRICS_SERVER_VERSION:-v0.5.0}
PAUSE_VERSION=${PAUSE_VERSION:-3.5}
KLIPPER_HELM_VERSION=${KLIPPER_HELM_VERSION:-v0.6.4-rancher1}
JETTECH_VERSION=${JETTECH_VERSION:-v1.5.2}
NGINX_INGRESS_VERSION=${NGINX_INGRESS_VERSION:-v1.0.0-rancher1}
NGINX_INGRESS_DEFAULT_BACKEND_VERSION=${NGINX_INGRESS_DEFAULT_BACKEND_VERSION:-1.5-rancher1}
KUBE_PROXY_VERSION=${KUBE_PROXY_VERSION:-v1.21.4-rke2r1}
CCM_VERSION=${CCM_VERSION:-v0.0.1}
CALICO_VERSION=${CALICO_VERSION:-v3.19.2}
CALICO_OPERATOR_VERSION=${CALICO_OPERATOR_VERSION:-v1.21.1}
CALICO_CRD_VERSION=${CALICO_CRD_VERSION:-v1.17.6}
FLANNEL_VERSION=${FLANNEL_VERSION:-v0.14.0}
CILIUM_VERSION=${CILIUM_VERSION:-v1.10.3}
...
SRIOV_RESOURCES_INJECTOR_VERSION=${SRIOV_RESOURCES_INJECTOR_VERSION:-v1}
