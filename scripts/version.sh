...
if [[ ! -z "$IMAGE_BUILD_VERSION" ]]; then IMAGE_BUILD_VERSION=-${IMAGE_BUILD_VERSION}
...
CALICO_BPFTOOL_VERSION=${CALICO_VERSION:-v5.10}
CALICO_BIRD_VERSION=${CALICO_VERSION:-v0.3.3}
