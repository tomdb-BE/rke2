...
RUN REPO=${REPO}/hardened-calico CHART_VERSION=${CALICO_CHART_VERSION}        CHART_TAG=${HARDENED_CALICO_VERSION}                                                             CHART_FILE=/charts/rke2-calico.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
RUN REPO=${REPO} CHART_VERSION=${CALICO_CHART_VERSION}                        CHART_TAG=${CALICO_VERSION}         CHART_TAG_CALICO_OPERATOR=${CALICO_OPERATOR_VERSION}         CHART_FILE=/charts/rke2-calico-crd.yaml     CHART_BOOTSTRAP=true   /charts/build-chart.sh
