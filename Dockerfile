...
RUN REPO=${REPO} CHART_VERSION=${CALICO_CHART_VERSION}                  CHART_TAG=${CALICO_VERSION}           CHART_TAG_CALICO_OPERATOR=${CALICO_OPERATOR_VERSION}  CHART_FILE=/charts/rke2-calico.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
RUN REPO=${REPO}/hardened-kube-proxy CHART_VERSION=${KUBE_PROXY_CHART_VERSION}             CHART_TAG=${KUBE_PROXY_VERSION}    CHART_PACKAGE=${KUBE_PROXY_CHART_PACKAGE_VERSION}            CHART_FILE=/charts/rke2-kube-proxy.yaml     CHART_BOOTSTRAP=true   /charts/build-chart.sh
