...
RUN CHART_VERSION=${KUBEPROXY_CHART_VERSION}                     CHART_TAG=${KUBE_PROXY_VERSION}${IMAGE_BUILD_VERSION}       CHART_FILE=/charts/rke2-kube-proxy.yaml     CHART_BOOTSTRAP=true   /charts/build-chart.sh
