...
ARG RUNC_VERSION
ARG REPO
ARG BASE_VERSION=v1.16.10b7-multiarch
...
ENV DAPPER_ENV GODEBUG REPO TAG DRONE_TAG PAT_USERNAME PAT_TOKEN KUBERNETES_VERSION DOCKER_BUILDKIT DRONE_BUILD_EVENT IMAGE_NAME GCLOUD_AUTH ENABLE_REGISTRY IMAGE_BUILD_VERSION VERSION REGISTRY K3S_VERSION CONTAINERD_VERSION CRICTL_VERSION RUNC_VERSION KUBERNETES_VERSION KUBERNETES_IMAGE_TAG COREDNS_VERSION ETCD_VERSION METRICS_SERVER_VERSION PAUSE_VERSION KLIPPER_HELM_VERSION JETTECH_VERSION NGINX_INGRESS_VERSION NGINX_INGRESS_DEFAULT_BACKEND_VERSION CCM_VERSION CALICO_VERSION CALICO_OPERATOR_VERSION CALICO_CRD_VERSION FLANNEL_VERSION CILIUM_VERSION CILIUM_STARTUP_SCRIPT_VERSION MULTUS_VERSION CNI_PLUGINS_VERSION SRIOV_VERSION SRIOV_DEVICE_PLUGIN_VERSION SRIOV_CNI_VERSION SRIOV_RESOURCES_INJECTOR_VERSION VSPHERE_CPI_VERSION VSPHERE_CSI_VERSION K8SCSI_CSI_ATTACHER_VERSION K8SCSI_CSI_NODE_DRIVER_VERSION K8SCSI_CSI_PROVISIONER_VERSION K8SCSI_CSI_RESIZER_VERSION K8SCSI_CSI_LIVENESSPROBE_VERSION CILIUM_CHART_VERSION CANAL_CHART_VERSION CALICO_CHART_VERSION CALICO_CRD_CHART_VERSION COREDNS_CHART_VERSION NGINX_INGRESS_CHART_VERSION METRICS_SERVER_CHART_VERSION MULTUS_CHART_VERSION VSPHERE_CPI_CHART_VERSION VSPHERE_CSI_CHART_VERSION CLUSTER_AUTOSCALER_VERSION DNS_NODE_CACHE_VERSION CERTGEN_VERSION HARVESTER_VERSION LONGHORN_REGISTRAR_VERSION LONGHORN_RESIZER_VERSION LONGHORN_PROVISIONER_VERSION LONGHORN_ATTACHER_VERSION ARVESTER_CLOUD_PROVIDER_CHART_VERSION HARVESTER_CSI_DRIVER_CHART_VERSION
...
ARG HARVESTER_CLOUD_PROVIDER_CHART_VERSION
ARG HARVESTER_CSI_DRIVER_CHART_VERSION
ARG REPO
...
COPY build/images/rke2-images.linux-${TARGETARCH}.tar.zst /var/lib/rancher/rke2/agent/images/
